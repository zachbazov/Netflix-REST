...
exports.createManySections =
    handlerFactory.createMany(Section);

exports.createPrimarySection =
    handlerFactory.createOne(Section);

exports.updateSection = handlerFactory.updateOne(Section);

exports.deleteSection = handlerFactory.deleteOne(Section);

exports.deleteAllSections =
    handlerFactory.deleteAll(Section);
